...
export const paths = {
  ...
  account: {
    ...
    operations: (id?: number | string | null) =>
      `/api/accounts/${id || ":id"}/operations`,
    byUser: (id?: number | string | null) =>
      `/api/accounts/by-user/${id || ":id"}`,
  },
  operation: {
  ...
  stock: {
    create: "/api/stocks",
    list: (params: QueryParams | undefined = undefined) =>
      `/api/stocks${buildQueryString(params)}`,
    update: (id?: number | string | null) => `/api/stocks/${id || ":id"}`,
    purchaseBaseStock: (id?: number | string | null) =>
      `/api/stocks/${id || ":id"}/purchase`,
  },
  stockOrder: {
    create: "/api/stock-orders",
    list: "/api/stock-orders",
    match: (id?: number | string | null) =>
      `/api/stock-orders/${id || ":id"}/match`,
    accept: (id?: number | string | null) =>
      `/api/stock-orders/${id || ":id"}/accept`,
  ...
  beneficiary: {
    ...
    list: (params: QueryParams | undefined = undefined) =>
      `/api/beneficiaries${buildQueryString(params)}`,
    update: (id?: number | string | null) =>
      `/api/beneficiaries/${id || ":id"}`,
  ...
  bankCredit: {
    ...
    payments: (id?: number | string | null) =>
      `/api/bank-credits/${id || ":id"}/payments`,
  },
  news: {
    create: "/api/news",
    list: (params: QueryParams | undefined = undefined) =>
  ...
  companyChannel: {
    ...
    detail: (id?: number | string | null) =>
      `/api/company-channels/${id || ":id"}`,
    update: (id?: number | string | null) =>
      `/api/company-channels/${id || ":id"}`,
    writeMessage: (id?: number | string | null) =>
      `/api/company-channels/${id || ":id"}/messages`,
  },
  privateChannel: {
    list: "/api/private-channels",
    detail: (id?: number | string | null) =>
      `/api/private-channels/${id || ":id"}`,
    update: (id?: number | string | null) =>
      `/api/private-channels/${id || ":id"}`,
    attributeTo: (id?: number | string | null) =>
      `/api/private-channels/${id || ":id"}/attribute-to`,
    writeMessage: (id?: number | string | null) =>
      `/api/private-channels/${id || ":id"}/messages`,
  },
  privateMessage: {
