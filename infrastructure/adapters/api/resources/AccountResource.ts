...
} from "../../../../application/services/api/ApiClientInterface";
...
import {
  ...
  GetHydratedAccountResponseInterface,
...
export class AccountResource implements AccountResourceInterface {
  ...
  public async get(
    ...
    return this.apiClient.get<GetHydratedAccountResponseInterface>(
      paths.account.detail(id)
    );
  }

  public async getAll(): Promise<
    GetAccountListResponseInterface | ApiClientError
  > {
    return this.apiClient.get<GetAccountListResponseInterface>(
      paths.account.list
    );
  }
  ...
  public async create(
    ...
    return this.apiClient.post<GetAccountResponseInterface>(
  ...
  public async update(
    ...
    return this.apiClient.put<GetAccountResponseInterface>(
      paths.account.update(data.id),
      data
    );
  }
  ...
  public async delete(
    id: number
  ): Promise<DeleteResponseInterface | ApiClientError> {
  ...
  public async getOperations(
    ...
    return this.apiClient.get<GetOperationListResponseInterface>(
      paths.account.operations(id)
    );
  }
