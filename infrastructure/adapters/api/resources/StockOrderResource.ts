...
export class StockOrderResource implements StockOrderResourceInterface {
  ...
  public async getAllForStock(stockId?: number): Promise<GetStockOrderListResponseInterface | ApiClientError> {
    return this.apiClient.get<GetStockOrderListResponseInterface>(`${paths.stock.list(stockId ? { stockId } : undefined)}`);
  }
