...
import { CreateStockOrderCommand } from "../../../domain/commands/stock-order/CreateStockOrderCommand";
import { InvalidCreateStockOrderCommandError } from "../../../domain/errors/commands/stock-order/InvalidCreateStockOrderCommandError";
import { GetStockOrderListUsecase } from "../../../application/usecases/stock-order/GetStockOrderListUsecase";
import { GetMatchStockOrderListParams } from "../../../domain/params/stock-order/GetMatchStockOrderListParams";
import { InvalidGetMatchStockOrderListParamsError } from "../../../domain/errors/params/stock-order/InvalidGetMatchStockOrderListParamsError";
import { GetMatchStockOrderListUsecase } from "../../../application/usecases/stock-order/GetMatchStockOrderListUsecase";
import { AcceptStockOrderParams } from "../../../domain/params/stock-order/AcceptStockOrderParams";
import { InvalidAcceptStockOrderParamsError } from "../../../domain/errors/params/stock-order/InvalidAcceptStockOrderParamsError";
import { AcceptStockOrderCommand } from "../../../domain/commands/stock-order/AcceptStockOrderCommand";
import { InvalidAcceptStockOrderCommandError } from "../../../domain/errors/commands/stock-order/InvalidAcceptStockOrderCommandError";
...
import { DeleteStockOrderParams } from "../../../domain/params/stock-order/DeleteStockOrderParams";
import { InvalidDeleteStockOrderParamsError } from "../../../domain/errors/params/stock-order/InvalidDeleteStockOrderParamsError";
...
export class StockOrderController {
  ...
  public async create(request: Request, response: Response) {
    ...
    const createUsecase = new CreateStockOrderUsecase(this.stockOrderRepository);
  ...
  public async match(request: Request, response: Response) {
    ...
    const getListUsecase = new GetMatchStockOrderListUsecase(this.stockOrderRepository);
  ...
  public async accept(request: Request, response: Response) {
    ...
    const maybeSuccess = await acceptUsecase.execute(
      owner,
      maybeCommand.withId,
      maybeParams.id,
    );
    ...
    await sendPurchaseEmailUsecase.execute(
      owner.email,
      'TODO get financial security here ?',
      0, 
    );
